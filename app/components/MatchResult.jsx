...
const s = {
  overlay: { position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '1.5rem', background: 'rgba(0,0,8,0.92)', fontFamily: 'monospace' },
  ...
  btn:     { marginTop: '1rem', fontFamily: 'monospace', fontSize: '0.9rem', color: '#000', background: '#00ffcc', border: 'none', padding: '0.65rem 2rem', cursor: 'pointer', letterSpacing: '0.15em', textTransform: 'uppercase' },
}
...
export default function MatchResult({ score, wpm, accuracy, wave, raceVictory, peakWPM, timeElapsed, gameMode }) {
  ...
  return (
    <div style={s.overlay}>
      ...
      <h1 style={{ ...s.title, color: "#ff4466" }}>Game Over</h1>
      <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem", alignItems: "center" }}>
