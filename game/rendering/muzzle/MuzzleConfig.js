...
//   forwardLocal:  direccion del disparo en espacio local del wrapper (antes de scale).
//   color/emissive: tomados de SHIP_PALETTES.
//   scale (opcional, default 1.0): multiplicador uniforme del bolt, laser y
//                                   anillo de boquilla de ESTE cañon. Ej. 0.6
//                                   = 60% del tamaño base. Aplicable a cualquier
//                                   nave; se pueden mezclar escalas distintas
//                                   por cañon si se quiere asimetria.
//
...
export const SHIP_MUZZLE_CONFIGS = {
  ...
  // z = marker rojo (+X) z = 0. Pequeña separacion vertical (Y), no muy abiertos.
  ...
  // cb1 — 2 cañones en marker rojo (+X tip), separacion horizontal en Z.
  // scale=0.6 → bolts/laser/anillos mas pequeños que el resto de naves.
  hangar_cb1_0: {
  ...
  // noseAxis='-z' → forwardLocal -Z (modelo). rotationY=-π en wrapper ajusta direccion a mundo.
  hangar_ig127_0: {
  ...
  // lowpoly (Acechador Nocturno) — 1 cañon en marker -Z (azul oscuro = nariz), poco mas abajo.
  hangar_lowpoly_0: {
  ...
  // Pares escalonados en Z para que no queden alineados uno detras del otro.
